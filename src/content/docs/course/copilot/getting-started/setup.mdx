...
description: "From a fresh editor to a working agent inside the orders-service repo. The install is a few clicks — what matters more is understanding that Copilot is one assistant wearing several surfaces."
sidebar:
