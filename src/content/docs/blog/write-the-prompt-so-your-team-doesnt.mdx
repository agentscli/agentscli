...
description: "Ship your team's recurring workflows as server-side MCP prompts that pre-load their own data. A teammate types a slash command and the context is attached."
authors: sanjay
date: 2026-05-31
