...
| **Isolated** - spawned with their own fresh window, do work, return only a summary | Zero on the parent window beyond that summary | [Subagents](/foundations/subagents/), [plan-mode](/foundations/plan-mode/) explorations you discard |
