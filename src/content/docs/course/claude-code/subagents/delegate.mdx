...
:::tip[Try it]
Ask Claude to investigate a noisy question inline (e.g., "find every place we handle date formatting"). Then ask the same question but say "delegate this to a subagent." Compare how clean your main conversation stays in each case.
:::
