...
For the per-tool mechanics, see [Rules](/foundations/rules/) for the canonical context, [Slash commands](/foundations/slash-commands/) for proposing edits, and [Hooks](/foundations/hooks/) for gating writes.
