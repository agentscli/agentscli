...
description: "Codex doesn't have one trust slider. It has two independent dials: how much the agent can do without asking (approval), and how far it can reach (sandbox). They combine."
sidebar:
