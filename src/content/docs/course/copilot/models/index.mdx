...
description: "The second dial. Permissions set how much Copilot may DO; this chapter sets how hard it THINKS — and like the first dial, the skill is spending the expensive setting only where it pays."
---
