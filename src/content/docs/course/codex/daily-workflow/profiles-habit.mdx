...
description: "You already know profiles exist. The reflex is having exactly two for budgetcli - one for exploring, one for working - and switching between them the instant the task changes shape, so your trust posture always matches what you're actually doing."
sidebar:
