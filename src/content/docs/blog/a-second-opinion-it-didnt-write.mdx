...
description: "An agent reviewing its own plan shares its blind spots. Wire a different vendor's model in as a gate, and a fail verdict re-engages planning before any code."
authors: sanjay
date: 2026-05-29
...
For the per-tool mechanics, see [Plan mode](/foundations/plan-mode/) for the exit boundary you're gating, [Hooks](/foundations/hooks/) for intercepting it deterministically, and [Model selection](/foundations/model-selection/) for choosing a reviewer from a different lineage.
