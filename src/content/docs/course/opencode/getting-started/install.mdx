...
:::note[Windows]
OpenCode runs on Windows via WSL2. Install it inside your WSL distribution, not on the Windows side. The TUI works in Windows Terminal with WSL.
:::
...
```
{/* VERIFY: install-transcript-illustrative */}
