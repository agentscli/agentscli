...
description: "The cloud agent runs async in an ephemeral GitHub Actions environment. Starting it is just an act of assignment — give it an issue the way you'd give one to a teammate, and it picks up the work on its own."
sidebar:
