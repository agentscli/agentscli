...
description: "Some work is worth doing but not worth keeping in your main thread. Push it into an isolated context, fan the heavy parts across parallel workers, and give each one its own working tree so they never read each other's half-written files."
---
