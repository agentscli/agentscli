...
GitHub Copilot is delivered through the current VS Code Copilot experience and its first-party extensions. Open the Extensions view, search for **GitHub Copilot**, and follow the installation or update prompts shown by your version of VS Code. The exact split between the Copilot and Copilot Chat extensions can change as VS Code ships new capabilities, so do not treat a separate companion extension as a permanent requirement.
