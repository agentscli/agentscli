...
{/* VERIFY: the mode facts are confirmed current - Cursor documents four modes (Agent, Ask, Plan, Debug), Ask is read-only, and Shift+Tab cycles modes (cursor.com/docs/agent/plan-mode); Debug mode is current as of changelog 2.2. Let the modes chapter own the Debug/Plan specifics. */}
