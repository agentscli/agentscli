---
title: "When your agent reads a webpage, that webpage can give it orders."
description: "Prompt injection is a context-engineering problem. Fence untrusted tool output as data, run a guardrail hook, and cap the blast radius with permissions."
authors: sanjay
date: 2026-05-29
...
For the per-tool mechanics, see [Rules](/foundations/rules/) for fencing untrusted content as data, [Hooks](/foundations/hooks/) for the parallel guardrail that cancels on a hit, and [Permissions](/foundations/permissions/) for capping the blast radius with an allowlist.
