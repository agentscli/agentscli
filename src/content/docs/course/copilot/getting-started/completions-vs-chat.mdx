...
description: "Copilot's inline completions and its Chat view are different tools for different moments. Knowing which one a task wants is the first real skill — and reaching for the wrong one is the most common early mistake."
sidebar:
