...
description: "Rules are context you author; auto memory is context the agent writes for itself as it works. Review it with /memory, and know which primitive fits what."
sidebar:
