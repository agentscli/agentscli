...
description: "A single giant root rules file dilutes the agent's attention. Split context into a broad root plus directory-scoped files it loads by what it's touching."
authors: sourabh
date: 2026-05-31
