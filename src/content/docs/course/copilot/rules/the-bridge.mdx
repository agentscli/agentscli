...
description: "The convention file you wrote for the Claude Code or Codex course is read natively by Copilot — same file, no rewrite. This is the payoff of the open-spec convergence the whole curriculum has been building toward."
sidebar:
