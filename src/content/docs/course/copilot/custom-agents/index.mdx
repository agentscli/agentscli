...
- **Fan subagents out across the consumers** - one coordinating agent delegating a breakage check to the available consumers - [Subagents · fan out across consumers](/course/copilot/custom-agents/subagents/)
