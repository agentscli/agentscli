...
description: "Stop describing things to the agent when you can hand it the real thing - a command's output with !, an exact file with @, a screenshot pasted straight in."
sidebar:
  label: "Inline · ! @ paste"
---
