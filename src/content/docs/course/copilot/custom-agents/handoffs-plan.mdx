...
The plan agent declares those handoffs; when it finishes producing the approach, the workflow transitions to `library-reviewer`, and from there to `consumer-audit`.
