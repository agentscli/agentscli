...
description: "Some things aren't conventions - they're whole multi-step requests you keep re-typing. Freeze one into a reusable prompt file you invoke with a slash command."
---
