...
description: "Your reviewer, your consumer-audit coordinator, and the built-in plan agent are three pieces of one careful sequence. Handoffs chain agents into a deliberate workflow, and planning the shared-lib change before any code turns Plan mode from Chapter 2 into a reusable, agent-driven step."
sidebar:
