...
description: "Hand the agent two committed documents - a requirements doc that fixes the destination and a phased plan that fixes the journey - and a feature too big for one window ships correctly anyway."
authors: sourabh
date: 2026-05-29
