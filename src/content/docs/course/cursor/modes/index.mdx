...
- **Ask** - the read-only detent, for when you can't yet name the change you want and need to learn the shape of the job first - [Ask: understand before you touch](/course/cursor/modes/ask/)
- **Agent** - full execution on a contained change, where reviewing a finished diff beats narrating every step - [Agent: full execution](/course/cursor/modes/agent/)
