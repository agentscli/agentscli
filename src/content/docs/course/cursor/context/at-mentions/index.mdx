...
sidebar:
  label: "@-mentions · The attach menu"
---
...
That whole inventory - the files, the folders, the docs, the manual rules - assumes you know what to attach. Cursor 2.0's bigger change is that increasingly you don't have to. [Next: self-gathering context](/course/cursor/context/self-gathering/).
