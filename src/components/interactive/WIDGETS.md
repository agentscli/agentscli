...
| `McpCostMeter` | `foundations/mcp-servers.mdx`, `course/claude-code/extending/mcp-connect.mdx`, `course/codex/extending/mcp-connect.mdx`, `course/copilot/extending/connect.mdx`, `course/opencode/extending/mcp-servers.mdx`, `course/cursor/extending/mcp/index.mdx` | context cost of mounted servers; order-of-magnitude schema sizes |
