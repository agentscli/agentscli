...
description: "An MCP server is a bridge to a system the agent can't otherwise see — a database, an issue tracker, a browser. Add one, and the agent reads and acts on that system directly instead of working from what you paste."
sidebar:
