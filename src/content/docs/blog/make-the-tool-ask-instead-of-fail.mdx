...
description: "When a tool call lacks a parameter, the agent's two instincts - fail or guess - are both wrong. Have the server elicit the missing field against a JSON schema and turn a half-specified request into a clean, validated dialogue."
authors: sourabh
date: 2026-05-31
