...
description: "The sandbox is the wall the agent can't climb. Read-only can't change anything, workspace-write can edit inside the project but not escape it, danger-full-access removes the fence entirely."
sidebar:
