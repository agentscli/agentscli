...
:::tip[Try it]
Open a session in your own repo and ask Claude to make a small change. Before you accept, run `git diff` and read every hunk. If anything surprises you, ask Claude to explain that specific line before you approve.
:::
