...
description: "The defaults are someone else's defaults, and the one chord you fire forty times a day is still two keystrokes behind a leader. Override only what you want in tui.json — bindings merge over the built-ins — collapse your hot chords, unbind what you never touch, and pick a theme you can stare at for a week with /theme."
sidebar:
