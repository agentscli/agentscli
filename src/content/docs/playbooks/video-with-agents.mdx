...
description: "Ask a model for a video and you get footage you can only re-roll. Route it through code and you get an artifact you can diff, fix, and re-render identically."
---
