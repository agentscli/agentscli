...
|---|---|---|---|---|---|---|
| First-class plugin format | Yes (static bundle) | **Yes** (skills + apps + MCP + hooks; no subagents - as of 2026-07) | Yes (live JS/TS) | **No** (no rules + skills + agents + hooks bundle) | Yes (preview, 2026) | **Yes** - Pi packages |
