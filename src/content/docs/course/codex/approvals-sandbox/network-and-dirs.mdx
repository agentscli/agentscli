...
description: "In workspace-write the agent can write files but can't reach the internet — it tries the exchange-rate API and fails. Turn network on with network_access; add directories with writable_roots and --add-dir."
sidebar:
