---
title: "Everyone's Designing Loops. Almost No One Asks What the Agent Knows at Each Tick."
description: "Loop engineering's six building blocks are all context primitives wearing new names. The scheduling is cron. The part that decides whether the loop works is the context delivered on every iteration."
authors: sanjay
date: 2026-06-20
tags: [context-engineering, skills, subagents, mcp, headless]
draft: true
---
