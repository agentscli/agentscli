...
For the per-tool mechanics, see [Subagents](/foundations/subagents/) for running the research in isolation, [Skills](/foundations/skills/) for the file format and progressive disclosure, and [Rules](/foundations/rules/) for pinning where new skills land.
