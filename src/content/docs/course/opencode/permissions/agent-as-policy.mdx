...
description: "Audit inherited code on a tight leash, then flip to a free hand to build - without touching a config file. In OpenCode the permission policy rides on the agent."
sidebar:
