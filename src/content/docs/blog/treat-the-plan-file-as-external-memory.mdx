...
description: "Stop fighting the context limit with a bigger window. Write an exhaustive plan to a file, then run a relay of fresh sessions that each tick off items - so a migration too big for any single context still ships coherently."
authors: sourabh
date: 2026-05-31
