...
description: "The procedure already exists as a Claude Code or Codex skill. OpenCode reads .claude/skills/ and .agents/skills/ directly, so point it at the folder as-is."
sidebar:
