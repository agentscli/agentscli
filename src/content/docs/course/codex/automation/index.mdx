---
title: "Automation"
description: "Take Codex out of the room. Run budgetcli's monthly report from a script and check new transactions in CI, without losing the sandbox and approval discipline."
sidebar:
