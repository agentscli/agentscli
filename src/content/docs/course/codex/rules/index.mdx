...
description: "Stop re-teaching budgetcli every session. Write the project's standing facts into AGENTS.md, the file Codex reads automatically before it does any work."
---
