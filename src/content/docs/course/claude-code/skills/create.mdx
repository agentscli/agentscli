...
:::tip[Try it]
Pick a three-step procedure you repeat weekly (test, lint, format). Write it as a SKILL.md in `.claude/skills/`. Start a fresh session and describe the situation - see if the skill fires without you naming it.
:::
