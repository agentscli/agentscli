...
description: "When a job splits into parts that don't depend on each other, spawn several subagents at once. Each works its slice in isolation; the parent synthesises the results. Plus the two tests for when parallelism is real leverage versus showing off."
sidebar:
