...
description: "Three ways to give Codex what it needs: a Skill it invokes on recognition, an AGENTS.md rule it always holds, a plain prompt for one-off work. Match the container to the job, then hand off to MCP and hooks."
sidebar:
