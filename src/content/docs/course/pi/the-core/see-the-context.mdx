...
description: "Not a summary of the context - the context itself. Tokens, cost, the raw session log, and the literal system prompt as sent. This is the feature that makes Pi worth learning specifically."
sidebar:
...
You now have direct access to *what's* in the window at any moment. The last piece is *why* it starts out so small in the first place - Pi's default system prompt is under a thousand tokens, and that's not an oversight. [Next: read the tiny prompt](/course/pi/the-core/the-tiny-prompt/).
