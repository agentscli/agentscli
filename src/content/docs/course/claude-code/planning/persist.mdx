...
description: "An approved plan lives in the conversation - and conversations get cleared, compacted, and closed. Get it onto disk before the context window loses it."
sidebar:
