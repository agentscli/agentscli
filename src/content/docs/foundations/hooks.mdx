...
The timeline above in the concrete: each tool's actual event names, where they sit in the session, and which ones can block. Click any event for what it fires on and a working config.
