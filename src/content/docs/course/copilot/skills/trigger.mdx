...
description: "A skill only fires if Copilot decides it applies, and that decision comes entirely from the description line. Write it as a trigger condition, not a summary."
sidebar:
