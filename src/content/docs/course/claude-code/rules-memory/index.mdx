---
title: "Rules & memory"
description: "Give the agent standing knowledge that survives every session - the build command, the domain facts, the conventions it currently rediscovers each time."
---
...
- **CLAUDE.md files** - instructions *you* write. Ancestor/project rules are loaded into the session; nested rules load on demand when Claude reads matching directories. Rules, conventions, and architecture belong here.
