...
One custom command — `/security-review` — traced from what you type, through the file that defines it, to the prompt the model actually receives. Watch where the arguments land (and where they can't):
