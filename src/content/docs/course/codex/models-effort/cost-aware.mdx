...
description: "More effort means more tokens and more latency — always, regardless of the price tag. The discipline that ties the chapter together: spend the heavy gear where the problem earns it, pull it back the moment the work goes mechanical, and reason about cost as a ratio, not a number."
sidebar:
