...
- [Write once, reuse across tools](/course/copilot/skills/the-standard/) - Agent Skills uses a shared format; the `SKILL.md` you write here may be reusable by Claude Code, Codex, and other supported tools.
