...
description: "Add the layer between you and the workers: leads who plan and delegate but never touch a file themselves. And the real reason to decompose a migration — it isn't context size, it's focus."
sidebar:
