...
description: "Turn a job you keep re-describing into a saved subagent - a markdown file that pins its name, tools, and model so it runs the same way every time."
sidebar:
