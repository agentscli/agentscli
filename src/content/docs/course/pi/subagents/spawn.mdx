...
description: "Pi's only multi-agent primitive: a second pi process, run headless, streaming machine-readable events on stdout. Everything else in this module is control flow on top of this one mechanism."
sidebar:
