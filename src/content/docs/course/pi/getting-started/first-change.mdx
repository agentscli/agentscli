...
description: "Hand Pi the feed-date bug in stash in plain English, watch the loop close without ever asking your permission, then read the diff and commit — because nothing stopped it from writing except you understanding what you asked for."
sidebar:
