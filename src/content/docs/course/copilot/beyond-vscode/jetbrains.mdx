...
description: "Open the same two repos in a JetBrains IDE and the agent is there too. Most of what you learned is generally available; a handful of features are still preview. The one thing that doesn't change at all: your rules files come along untouched."
sidebar:
