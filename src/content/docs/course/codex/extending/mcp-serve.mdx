...
description: "MCP runs both ways. Stand Codex up as a server and it becomes a tool a bigger system can call - the move for when something else owns the outer loop."
sidebar:
