...
description: "You don't have to give up VS Code or your JetBrains IDE. Codex is the agent layer that sits next to the inline completion you already have - a different job, not a replacement."
sidebar:
