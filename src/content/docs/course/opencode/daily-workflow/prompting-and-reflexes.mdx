...
:::tip[Try it]
For your next three tasks, write the goal, context, constraints, and completion criteria before you prompt. After each, check whether the agent met your criteria or drifted. If it drifted, rewrite the prompt from scratch instead of nudging.
:::
