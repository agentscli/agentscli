...
description: "A second feed breaks while you're mid-fix on the first. Switch sessions instead of tangling two threads, then carry today's context forward with --continue."
sidebar:
