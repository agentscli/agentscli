...
description: "Knowing what the four modes do is table stakes. Reading a task and knowing which one it wants is the skill - and blast radius decides it, not difficulty."
sidebar:
