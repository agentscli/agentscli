...
As of mid-2026, the picker typically includes GPT-4o, Claude Sonnet, and o3-mini, among others. The exact list changes as GitHub adds and retires models - treat this as a snapshot, not a promise.
