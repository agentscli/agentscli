...
description: "A hundred-file scan on your top-tier reasoner is money burned. Pin a per-agent model so the read-only scout runs cheap and your build loop keeps the strong one."
sidebar:
