...
**Environment variables:** `CURSOR_API_KEY` is documented for headless / CI auth. Other variables are surface-specific; use the current [CLI parameter reference](https://docs.cursor.com/en/cli/reference/parameters) before relying on one.
