...
description: "AGENTS.md is guidance the model interprets, not configuration it's forced to obey — so concrete, testable rules land and vague ones get skimmed past. The difference between a rule Codex follows and one it ignores, shown on budgetcli."
sidebar:
