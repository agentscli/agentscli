...
description: "MCP is the standard protocol for plugging external systems - issue trackers, databases, design tools - into AI agents. Here's what changes when you use it."
seoTitle: "MCP Servers: Connect AI Agents to Jira, Postgres, Figma"
seoDescription: "MCP is the protocol that lets an agent call jira.get_ticket or postgres.describe_table itself, instead of you copy-pasting context by hand."
authors: sanjay
date: 2026-05-20
tags: [context-engineering, mcp-servers]
draft: false
---
...
For the per-tool mechanics, see [MCP servers](/foundations/mcp-servers/) for where servers are configured, scopes, and transport options.
