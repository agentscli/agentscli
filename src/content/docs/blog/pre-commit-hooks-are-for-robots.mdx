...
description: "A git pre-commit hook turns 'the agent should run the tests' into 'the agent cannot commit broken code' - a deterministic gate that ships with every clone."
authors: sanjay
date: 2026-05-31
