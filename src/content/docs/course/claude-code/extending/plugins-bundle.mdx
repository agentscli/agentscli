...
description: "A plugin packages commands, skills, agents, hooks, and MCP config into one installable unit. Here we fold the whole payments setup — the database connection, the ledger gate, the PR ritual — into a single plugin."
sidebar:
