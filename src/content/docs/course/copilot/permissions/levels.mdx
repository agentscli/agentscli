...
description: "Default, Bypass Approvals, and Autopilot — what each one auto-runs and what it still stops to ask about. The setting that decides how much rope you hand the agent, persisted per workspace."
sidebar:
