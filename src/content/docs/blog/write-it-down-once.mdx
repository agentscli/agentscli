...
seoTitle: "AGENTS.md: One Rules File Every AI Coding Tool Reads"
seoDescription: "Copilot, Cursor, Claude Code, Codex, and OpenCode all converged on reading a rules file each session. Write context down once and every tool gets it."
authors: sanjay
date: 2026-05-20
...
For the per-tool mechanics, see [Rules](/foundations/rules/) for layering, path-scoping, nested files, and how each tool merges multiple sources.
