...
description: "Your first half-hour with Copilot in VS Code - from a fresh extension to one small, reviewed change shipped from a service you've just inherited."
---
