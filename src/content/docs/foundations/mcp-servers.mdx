...
The second bullet above, made tangible. Toggle servers on and off and watch what their tool schemas cost before you've typed a single message — then flip on schema deferral to see why it exists.
