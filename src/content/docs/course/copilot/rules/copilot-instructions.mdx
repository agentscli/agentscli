...
:::tip[Try it]
Write three rules in `.github/copilot-instructions.md` for your repo: one about naming, one about error handling, one about test style. Open a fresh chat and ask for a small feature without mentioning the rules. Check whether Copilot's first draft already follows all three - if it misses one, that's a rule that needs sharper wording.
:::
