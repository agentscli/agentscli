...
description: "The ephemeral environment the cloud agent runs in is configurable through one file - copilot-setup-steps.yml. Shape what it can do and how long it gets, and know who's allowed to switch the whole thing on in the first place."
sidebar:
