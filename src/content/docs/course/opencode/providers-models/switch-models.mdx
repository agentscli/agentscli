...
:::tip[Try it]
Give OpenCode a mechanical task (rename a struct field across feedmill) on your default model. Then press `ctrl+t` to cycle the thinking effort up and ask a design question about the same code. Notice the difference in response depth and latency.
:::
