...
description: "A rule asks the model; a permission asks the model first too. A hook doesn't ask anyone - it's deterministic code on the rail. Knowing which guarantee you actually need is the skill."
sidebar:
