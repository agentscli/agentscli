...
description: "Edit mode edits exactly the files you name and nowhere else. When you already know where the work goes, that boundary is a feature, not a limitation."
sidebar:
