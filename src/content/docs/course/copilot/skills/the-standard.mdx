...
description: "Agent Skills is an open standard. Your SKILL.md isn't a Copilot file - it's the same file VS Code, the CLI, the cloud agent, and your other agents read."
sidebar:
