...
description: "Your debugging ability isn't intelligence, it's a procedure - and procedures are exactly what you write down once and hand to an agent. Start with a meta-skill."
authors: sanjay
date: 2026-05-29
...
For the per-tool mechanics, see [Skills](/foundations/skills/) for the file format and progressive disclosure, [Rules](/foundations/rules/) for routing the agent to the right procedure, and [Slash commands](/foundations/slash-commands/) for invoking procedures by hand.
