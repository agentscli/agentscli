...
description: "An MCP server is a trust boundary, not a passthrough. Hold every secret server-side and expose a curated verb set, so a prompt-injected agent is bounded by the tools you chose - not your full API surface."
authors: sanjay
date: 2026-05-31
