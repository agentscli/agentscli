...
description: "You keep reaching for a mouse that isn't there. Learn the ctrl+x leader chords and the ctrl+p palette so every action is two keystrokes and fully discoverable."
sidebar:
