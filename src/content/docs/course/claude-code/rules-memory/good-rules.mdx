...
description: "A CLAUDE.md is loaded into every session, so every line costs context. The rules that earn their place are specific and project-true; the ones that waste it are vague, generic, or already obvious from the code."
sidebar:
