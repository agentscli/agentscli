...
description: "Tight permissions on shared-lib, loose on orders-service — same engineer, same week, opposite settings, set by what's at stake. The permission level is how the blast-radius judgment becomes a setting. This closes Act 1."
sidebar:
