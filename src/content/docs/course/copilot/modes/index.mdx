---
title: "The modes"
description: "Copilot's signature shape - Ask, Edit, Agent, and Plan. Four levels of latitude inside the same chat, and the skill that defines a strong Copilot user is picking the one that matches what's at stake."
---
