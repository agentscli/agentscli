...
| Subagent access control | `skills:` field preloads | `[[skills.config]]` in agent TOML (earlier enable/disable override bug openai/codex#14161 fixed in a later Codex release) | `permission.skill` rules per agent gate which skills are visible | — | — |
