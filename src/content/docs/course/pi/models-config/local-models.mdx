...
A local 7B model on Apple Silicon runs at roughly 15-25 tokens/second - usable for micro tasks, painful for multi-file work. The cost is zero, but the time cost is real.
