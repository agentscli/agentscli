...
description: "Agent mode plans, edits across the files it decides matter, runs commands and tests, and self-corrects until the task is done. It's the most powerful mode and the one that most demands you stay in the loop on what it runs."
sidebar:
