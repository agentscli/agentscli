...
- **Default to Auto.** The two-pool model (covered in [Pricing pools](/course/cursor/models/pricing-pools/)) means this draws from the included pool. Most of your day belongs here.
- **Reach for Composer** when you want Cursor's own agentic model by name - still in the included pool.
