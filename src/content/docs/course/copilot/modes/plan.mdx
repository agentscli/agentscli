...
description: "Plan mode produces a structured, reviewable plan before any code is written. When the approach is the risky part — not the typing — reviewing the plan is where the real decisions get made."
sidebar:
