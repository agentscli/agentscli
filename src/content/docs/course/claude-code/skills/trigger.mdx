...
description: "The description is the trigger surface Claude matches your request against. Tune it so the ritual fires when a PR is ready and stays quiet otherwise."
sidebar:
