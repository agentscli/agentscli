...
description: "When the plan is ready, Claude asks how to proceed. You can edit the plan yourself, send it back for changes, or approve it straight into the build mode that fits the work."
sidebar:
