...
description: "Hand the ordering bug to Copilot Chat, read the diff before you accept it, and commit. The change is tiny on purpose - the habit it builds carries the course."
sidebar:
...
:::tip[Try it]
Open the Chat view in your own repo and describe a small bug - a wrong default, a misnamed field, anything you can verify in thirty seconds. Before you accept the suggestion, read the diff against the three-point checklist above. If anything surprises you, don't just reject it; ask Copilot to explain that specific change and read whether its reasoning holds.
:::
