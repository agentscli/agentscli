...
description: "The cloud agent never pushes to your main branch. It opens a draft pull request - a proposal you review, iterate on with @copilot, and merge yourself."
sidebar:
