...
description: "The whole of automation starts here: a single flag that turns the interactive agent into a command-line tool you can pipe into, script around, and read the result back from."
sidebar:
