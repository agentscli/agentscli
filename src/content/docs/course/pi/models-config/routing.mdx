...
:::tip[Try it]
Open `models.json` and set a cheap model for mechanical tasks. Give Pi a rename-across-files job in stash and watch it use the cheap model, then ask a design question and notice the routing shift. Check `opencode stats` (or Pi's cost display) to confirm the difference in spend.
:::
