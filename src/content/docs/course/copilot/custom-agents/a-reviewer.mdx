...
description: "Build a library-reviewer agent that holds shared-lib's one hard rule - add surface, never break what twelve consumers depend on - so you stop re-explaining it."
sidebar:
