...
```json title=".cursor/hooks.json"
{
  ...
  "hooks": {
    "beforeShellExecution": [
      { "command": "./.cursor/hooks/protect-ledger.sh", "matcher": ".*" }
    ]
  }
}
```
