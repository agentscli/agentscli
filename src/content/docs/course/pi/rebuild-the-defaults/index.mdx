...
description: "Pi ships with no guardrails at all, on purpose. Now that stash holds real saved data and real secrets, you rebuild the ones you actually need - as extensions you can read line by line, not a hidden black box."
---
