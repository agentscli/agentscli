...
description: "You don't have to give up VS Code or Neovim to run a terminal agent. Set $EDITOR for the /editor composer, stay on the keyboard with the @ file picker and ! inline bash, and connect OpenCode over ACP so it runs beside your IDE - sharing the same LSP diagnostics your editor already draws."
sidebar:
