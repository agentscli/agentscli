...
For the per-tool mechanics, see [MCP servers](/foundations/mcp-servers/) for the gateway, [Permissions](/foundations/permissions/) for the client-side allowlist, and [Configuration](/foundations/configuration/) for wiring it into your agent.
