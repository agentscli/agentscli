...
description: "You re-narrate the same chore to OpenCode every morning. Write it once as a markdown command, pass the changing bit as an argument, and it becomes one slash."
sidebar:
