...
description: "A new MCP server is code reaching outside your editor, so Copilot won't start it until you confirm - and the same care governs every tool call it makes after."
sidebar:
