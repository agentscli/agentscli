...
description: "Permissions gate opencode's tools, not your OS — there's no built-in sandbox to wall the agent off from your machine. When you want to leave feedmill running unattended, wrap the whole CLI in a container; the same move is what makes it trivial to run in CI later."
sidebar:
