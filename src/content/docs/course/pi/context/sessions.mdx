...
description: "pi --continue to pick a session back up, /resume to reach further back, /fork to explore or correct without losing the original thread, /tree to see the branches, and a fresh-session command for when today has nothing to do with yesterday."
sidebar:
