...
- **Pick how much runs unattended, and find the wall** - the auto-run modes, plus the OS-enforced Agent Sandbox that actually holds - [Auto-run and the sandbox](/course/cursor/permissions/auto-run/)
