...
description: "There's a terminal-native surface for the same assistant - same account, same rules - for the moments you're already in a shell and don't want to reach for the editor. It's a footnote, and this lesson treats it like one."
sidebar:
