...
description: "The headless command, fired by a push instead of by you. Authenticate with an API key, commit to a sandbox-and-approval posture up front, and the categoriser-and-tests run on every batch of new transactions before anyone looks."
sidebar:
