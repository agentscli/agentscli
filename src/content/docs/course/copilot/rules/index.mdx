...
description: "You kept hand-feeding Copilot your team's conventions - the sort idiom, the audit-event style, the shape each file expects. This chapter writes them down once, in files Copilot reads on every request, so its first draft already conforms."
---
