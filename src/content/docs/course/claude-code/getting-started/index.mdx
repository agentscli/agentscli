...
- [Install it and open it in the repo](/course/claude-code/getting-started/install/).
- [Sign in and ask it to explain the code](/course/claude-code/getting-started/authenticate/) before it touches anything.
- [Hand it the ticket](/course/claude-code/getting-started/first-change/) and watch the read→edit→verify rhythm.
- [Check its work](/course/claude-code/getting-started/review/): read the diff, undo if wrong, commit when right.
- [Wire it into your editor](/course/claude-code/getting-started/editor/) so this becomes a daily habit, not a detour.
