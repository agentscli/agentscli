...
description: "Hand a coworker the whole stuck session as a public URL with /share, revoke it with /unshare - then make an accidental share impossible on a proprietary repo."
sidebar:
