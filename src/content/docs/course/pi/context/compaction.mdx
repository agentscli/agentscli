...
description: "Your window fills mid-refactor and Pi condenses the thread on its own. What triggers it, what the summary keeps, and the one edge case worth knowing."
sidebar:
