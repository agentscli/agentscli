...
- [Reach for the Codex SDK when `exec` runs out of room](/course/codex/automation/sdk/) - programmatic thread control, and when broader orchestration belongs in the Agents SDK
