...
description: "An autonomous agent isn't a bigger context window. It's a tiny window run many times, where the git log - not chat history - carries decisions between passes."
authors: sanjay
date: 2026-05-29
