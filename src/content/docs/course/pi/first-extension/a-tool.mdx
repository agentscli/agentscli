...
description: "pi.registerTool gives the model something it can call, not just something you can. TypeBox schema, streamed progress, and the return shape that decides whether the model gets to comment on the result."
sidebar:
