...
description: "None of the built-in three enforces your rule and can never edit. Hand-write a markdown subagent with a pinned model and a permission map, scoped to one job."
sidebar:
