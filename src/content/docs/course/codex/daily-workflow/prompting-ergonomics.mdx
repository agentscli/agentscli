...
That's most of the friction. You've got profiles you switch by instinct, briefs sharp enough that runs go where you meant, and the small ergonomics that make the common case free. But even sharp briefs go sideways sometimes - [the next lesson](/course/codex/daily-workflow/error-recovery/) is the recovery reflex for when a run loops or drifts.
