...
description: "Scatter gating logic inline and consistency depends on luck. Collapse the policy into one named helper, make calling it a rule, and enforcement is the default."
authors: sourabh
date: 2026-05-31
