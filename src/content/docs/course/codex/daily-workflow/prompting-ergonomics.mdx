...
description: "Vagueness is cheap in chat and expensive in an agent — a loose prompt buys you minutes of compute and a pile of unwanted edits. Give the agent the four things a good brief carries, learn to stop-and-rewrite instead of nudging a bad run, and shave the small input friction off the surface you touch most."
sidebar:
