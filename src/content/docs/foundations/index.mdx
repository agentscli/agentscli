...
| [Plan mode](/foundations/plan-mode/) | Shift-Tab cycle (4 modes) | Permission/sandbox posture (`untrusted` + `read-only`) | `plan` primary agent | First-class IDE mode | Mode dropdown (Plan agent) | - (file a plan, or extension/package) |
