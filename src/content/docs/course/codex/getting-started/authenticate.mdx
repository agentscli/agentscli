...
Both are fully supported, and you can switch later. The current list of supported flows and their setup lives in the [authentication docs](https://developers.openai.com/codex/auth) - that's the page to check if a sign-in misbehaves.
