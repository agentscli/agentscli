...
description: "Hand Cursor the CSV date bug in plain English, watch the Agent edit your files, then review the red/green diff and Keep or Undo it yourself before you commit - because it's your name on the change and your money in the database."
sidebar:
...
Your first change is described, applied, reviewed in the diff, kept, and committed - the whole loop, closed once by hand on a real bug. The shape never changes for the rest of the course; what changes is how much latitude you give the Agent to run it. That latitude is the next thing to learn - starting with the surface you'll reach for a hundred times a day: [the Agent sidebar and Tab, side by side](/course/cursor/getting-started/two-surfaces/).
