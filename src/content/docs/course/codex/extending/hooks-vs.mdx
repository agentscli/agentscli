...
description: "A rule asks the model. An approval setting asks the model first too. A hook asks no one - it's deterministic code on the rail. Knowing which guarantee you actually need is the skill, and it's what makes unattended runs safe."
sidebar:
