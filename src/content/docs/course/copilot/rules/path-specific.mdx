...
description: "shared-lib's twelve-consumer helpers need stricter rules than the rest of the code. Scope them to a path with applyTo, layered on top of the repo-wide file."
sidebar:
