...
description: "From nothing installed to a running agent inside the budgetcli repo. The install is a one-liner - what matters more is knowing the agent is one tool with several front doors."
sidebar:
