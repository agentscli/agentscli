---
title: "Planning"
description: "Some changes are too big to let the agent start editing blind. Plan mode makes Claude Code research and propose first — you approve the approach before a single line changes."
---
