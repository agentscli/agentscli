...
description: "Your judgment - which tradeoff, which edge cases, which empty states - lives only in your head until something extracts it. A saved procedure that explores the repo, then grills you one branch at a time, turns a vague idea into a codebase-aware spec the agent can build against."
authors: sanjay
date: 2026-05-29
