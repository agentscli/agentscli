...
description: "pi.on is the primitive under every extension you'll write - permissions, task discipline, subagents. The full event list, and how to block a tool call."
sidebar:
